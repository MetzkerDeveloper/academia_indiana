...
@section('content')
    <div class="w-full flex flex-col items-center justify-center pb-20 sm:mb-20">
        ...
        @if (count($gamesUser)== 0 )
            <p class="text-white mt-20">Você não possui jogos cadastrados!
                 Cadastre um novo jogo clicando <a href="{{url('addGame')}}" class="text-blue-700 hover:text-blue-500"> aqui.</a></p>
